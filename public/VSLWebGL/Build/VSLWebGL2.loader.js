      ...
      S = {
        ...
        GetMetricsInfo: function () {
          ...
          return {
            ...
            numJankedFrames: m.HEAPU32[(u + 4) >> 2],
          };
        },
      };
    function P(e, t, n) {
        ...
        a =
          ...
          n(m[t], {
            ...
            .then(function (e) {
              var t, n, r, o, a, i;
              return (
                k.gzip.hasUnityMarker(e.parsedBody) && (t = ["gzip", "gzip"]),
                (t = k.br.hasUnityMarker(e.parsedBody) ? ["brotli", "br"] : t) &&
